...
class HorusAI: SekhmetAI {
    override init(game: PyramidGame) {
        ...
        self.bluffProbabilities = [10,35,45,80,60]
    }
    ...
    override func textAICallCorrectMistake(points:Int)->String { return "I seem to have misremembered. I will not do that again.\nYou get \(points) points." }
